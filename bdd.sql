...
-- Listage des données de la table cinema_gino.acteur : ~14 rows (environ)
...
-- Listage des données de la table cinema_gino.casting : ~20 rows (environ)
...
-- Listage des données de la table cinema_gino.film : ~7 rows (environ)
INSERT INTO `film` (`id_film`, `titre`, `parution`, `duree`, `synopsis`, `note`, `affiche`, `id_realisateur`) VALUES
	...
	(26, 'Oppenheimer', '2024-04-03 00:00:00', 10, 'dd', 5, 'public/img/affiches/660d161cf1eed0.89389295.webp', 1);
...
-- Listage des données de la table cinema_gino.genre : ~11 rows (environ)
...
-- Listage des données de la table cinema_gino.genre_film : ~28 rows (environ)
...
-- Listage des données de la table cinema_gino.personne : ~17 rows (environ)
INSERT INTO `personne` (`id_personne`, `prenom`, `nom`, `sexe`, `dateNaissance`, `photo`) VALUES
	...
	(34, 'Georges', 'Miller', 'Homme', '2024-04-04', 'public/img/personnes/660d6b7c84d118.02632668.jpg'),
	(36, 'Jamie', 'Fox', 'Homme', '2024-04-11', 'public/img/personnes/660d4b423667f9.30277279.webp'),
	(37, 'hoffman', 'albert', 'Homme', '2024-04-02', 'public/img/personnes/660e4eae0c5d22.36353872.webp');
...
-- Listage des données de la table cinema_gino.realisateur : ~4 rows (environ)
...
-- Listage des données de la table cinema_gino.role : ~10 rows (environ)
